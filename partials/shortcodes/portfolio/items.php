...
<div class="portfolio isotope no-transition portfolio-<?php echo $shape; ?> <?php echo $shadow_class; ?> <?php echo $container_class; ?> row"><?php
foreach( $posts as $post ):
    ...
    $link_target = empty($link_target) ? '' : ' ' . $link_target .'"';
    ...
    <div class="portfolio-item infinite-item <?php echo implode( ' ', $classes ); ?>" >
        ...
        if($show_overlay == 'show'): ?>
            ...
            if($show_excerpt == 'show'): ?>
                ...
                <a class="<?php echo $item_data->popup_class; ?> more" href="<?php echo $item_data->popup_link; ?>" title="<?php echo $item_data->title;?> "<?php echo $gallery_images; ?> >
...
if( $pagination !== 'off' ):
    oxy_pagination(ceil(wp_count_posts('oxy_portfolio_image')->publish/$count),2, false, $pagination == 'infinite', true);
endif; ?>
