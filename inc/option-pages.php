    ...
    $oxy_theme->register_option_page( array(
        ...
        'sections'   => array(
            'permalinks-section' => array(
                ...
                'header'  => __('Some of the custom single pages ( Portfolios, Services, Staff ) can be configured to use their own specoal url.  This helps with SEO.  Set your permalinks here, save and then navigate to one of the items and you will see the url in the format below.', 'angle-admin-td'),
                'fields' => array(
                    array(
    ...
    $oxy_theme->register_option_page( array(
        ...
        'sections'   => array(
            'css-section' => array(
                ...
                'header'  => __('Here you can save some custom CSS that will be loaded in the header.  This will allow you to override some of the default styling of the theme.', 'angle-admin-td'),
                'fields' => array(
                    array(
