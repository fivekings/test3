...
//             'desc'    => __('Set the colour scheme that will be used for this item.', 'angle-admin-td'),
//             'id'      => 'swatch',
//             'type' => 'select',
...
//         array(
//             'name'    => __('Swatch', 'angle-admin-td'),
//             'desc'    => __('Set the colour scheme that will be used for post.', 'angle-admin-td'),
//             'id'      => 'swatch',
//             'type' => 'select',
...
// $oxy_theme->register_metabox( array(
//     'id' => 'site_header',
//     'title' => __('Site Header', 'angle-admin-td'),
//     'priority' => 'default',
//     'context' => 'advanced',
//     'pages' => array('page'),
//     'fields' => array(
//         array(
//             'name' => __('Show Site Header', 'angle-admin-td'),
//             'id'   => 'show_site_header',
//             'type' => 'select',
//             'desc' => __('Removes the whole site header (logo and menu) - useful for landing pages', 'angle-admin-td'),
//             'default' => 'show',
//             'options' => array(
//                 'hide'      => __('Hide', 'angle-admin-td'),
//                 'show'      => __('Show', 'angle-admin-td'),
...
//     'title' => __('Link target', 'angle-admin-td'),
//     'priority' => 'default',
//     'context' => 'advanced',
//     'pages' => array('oxy_service'),
//     'fields' => array(
//         array(
//             'name' => __('Link Target', 'angle-admin-td'),
//             'desc'     => __('Choose how this item will be opened up in the browser.  In a new window / tab or ths same window.', 'angle-admin-td'),
//             'id'   => 'link_target',
//             'type' => 'select',
//             'options' => array(
//                 '_self'   => __('Same page as it was clicked ', 'angle-admin-td'),
//                 '_blank'  => __('Open in new window/tab', 'angle-admin-td'),
//                 '_parent' => __('Open in the parent frameset', 'angle-admin-td'),
//                 '_top'    => __('Open in the full body of the window', 'angle-admin-td')
//             ),
//         ),
//     )
// ));
